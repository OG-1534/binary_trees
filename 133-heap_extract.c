 ...
 *
 * Return: height of Binary Tree, if tree is NULL, 0
 */
...
/**
 * tree_size_h - function that measures the sum of heights
 * of a binary tree
 *
 * @tree: pointer to the root node of the tree to measure height
 *
...
/**
 * _preorder - function that uses pre-order traversal
 * to go through a Binary Tree
 *
...
/**
 * heapify - heap Max Binary Heap
 *
 * @root: pointer to Max Binary Heap
 */
